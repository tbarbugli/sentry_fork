...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sentry_message', 'url', self.gf('sentry.utils.fields.URLTextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Message.url'
        db.alter_column('sentry_message', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
