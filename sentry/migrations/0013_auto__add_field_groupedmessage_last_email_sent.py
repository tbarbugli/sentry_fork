...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupedMessage.last_email_sent'
        db.add_column('sentry_groupedmessage', 'last_email_sent', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupedMessage.last_email_sent'
        db.delete_column('sentry_groupedmessage', 'last_email_sent')
